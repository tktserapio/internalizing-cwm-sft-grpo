...
def check_line(board: List[List[str]], row: int, col: int, mark: str, d_row: int, d_col: int) -> bool:
    """Check a line in a specific direction for a win."""
    count = 0
    for delta in range(-WIN_LENGTH + 1, WIN_LENGTH):
        r, c = row + delta * d_row, col + delta * d_col
